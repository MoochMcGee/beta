...
namespace Beta.GameBoy.Boards
{
    public class BoardFactory : IBoardFactory
    {
        ...
        public BoardFactory(IAddressSpace addressSpace)
        {
        ...
        public Board Create(byte[] binary)
        {
            ...
            switch (type)
            {
            case 0x00: return new Board(addressSpace, binary); // ROM ONLY
            case 0x01:
            case 0x02:
            case 0x03: return new NintendoMbc1(addressSpace, binary);
            case 0x05:
            case 0x06: return new NintendoMbc2(addressSpace, binary);
            ...
            case 0x11:
            case 0x12:
            case 0x13: return new NintendoMbc3(addressSpace, binary);
            ...
            case 0x1c:
            case 0x1d:
            case 0x1e: return new NintendoMbc5(addressSpace, binary);
